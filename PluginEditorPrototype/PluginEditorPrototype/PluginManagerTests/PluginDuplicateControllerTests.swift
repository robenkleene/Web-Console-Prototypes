...
//    
//    func testCopyPlugin() {
//        var testPluginURL = pluginDuplicateController.duplicatePlugin(plugin!, toDirectoryAtURL: pluginDuplicateController.duplicateTempDirectoryURL)
...
//    
//    func testCleanUp() {
//        pluginDuplicateController.duplicatePlugin(plugin!, toDirectoryAtURL: pluginDuplicateController.duplicateTempDirectoryURL)
//
