...
NSString * const WCLFileExtensionPluginsKey_old = @"plugins";
NSString * const WCLFileExtensionExtensionKey_old = @"extension";
...
@interface WCLFileExtension_old ()
...
@implementation WCLFileExtension_old
...
- (id)initWithExtension:(NSString *)extension {
    ...
    if (self) {
        ...
        [self addObserver:self
               forKeyPath:WCLFileExtensionPluginsKey_old
...
- (NSArrayController *)pluginsArrayController
{
    ...
    [_pluginsArrayController bind:@"contentArray" toObject:self withKeyPath:WCLFileExtensionPluginsKey_old options:nil];
...
- (void)dealloc
{
    [self removeObserver:self forKeyPath:WCLFileExtensionPluginsKey_old];
                       ...
                       context:(void *)context
{
    ...
    if ([keyPath isEqualToString:WCLFileExtensionPluginsKey_old]) {
